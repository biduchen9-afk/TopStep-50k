...
def main():
    print("=" * 72)
    print("9-STREAM ENSEMBLE -- RE-EVALUATED ON DATABENTO DATASET (2010-2026)")
    print("Strategies: ORB + MeanRev + OvernightDrift x ES + NQ + GC")
    print("Same params/gates as the original OOS_PROMOTED run -- more history")
    print("=" * 72)
    ...
    # ── Per-stream IS stats + pass-rate-aware weights (IS only) ────────────
    print(f"\n{'─'*72}")
